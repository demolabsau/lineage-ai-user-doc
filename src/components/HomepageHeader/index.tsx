...
import { LandingPrimaryVideoCtaSection } from '@site/src/components/landing/cta/LandingPrimaryCta';

import { Button } from '@site/src/components/shared/ui/button';
import { colors } from '@site/src/data/colors';
    ...
    <>
      <LandingPrimaryVideoCtaSection
        titleComponent={
          <div>
            ...
            <h2 className="text-6xl font-semibold leading-tight">
              <span className="text-primary-800">AI-Powered</span> Data Lineage
            </h2>
          </div>
        }
        description="Lineage AI captures and visualizes data lineage across data pipelines, empowering data governance with no overhead."
        autoPlay
        controls={false}
        textPosition="center"
      ...
      >
        <div className="w-full mt-6 flex flex-col justify-center gap-4">
          <Button size="xl" className="p-7 text-xl" variant="primary">
            Try Lineage AI
          </Button>
        </div>
      </LandingPrimaryVideoCtaSection>
