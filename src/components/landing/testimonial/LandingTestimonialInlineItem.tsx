import { LandingRating } from '@site/src/components/landing/rating/LandingRating';
import { LandingAvatar } from '@site/src/components/landing/social-proof/LandingAvatar';
